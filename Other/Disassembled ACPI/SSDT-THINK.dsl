...
DefinitionBlock ("", "SSDT", 2, "hack", "Think", 0x00000000)
{
    ...
    External (_SB.PCI0.LPC.EC.HFSP, FieldUnitObj)    // Fan control register
    External (_SB.PCI0.LPC.EC.HFNI, FieldUnitObj)    // Fan control register
    External (_SB.PCI0.LPC.EC.VRST, FieldUnitObj)    // Second fan switch register
